...
public class JsonTweetsBlockTest {
  private static final String createTweet(long id, String text) {
    return "{\"id\":" + id + ",\"text\":\"" + text + "\",\"place\":{\"full_name\":\"q23\"},\"user\":{\"screen_name\":\"foo\",\"followers_count\":1,\"friends_count\":1,\"statuses_count\":1},\"created_at\":\"Fri Feb 01 00:00:00 +0000 2013\"}";
  }
